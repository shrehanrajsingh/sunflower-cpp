#include "isdecimal.hpp"
#include <cctype>

namespace sf
{
SF_API Object *
_native_isdecimal (Module *mod)
{
...
SF_API void
_add_native_isdecimal (Vec<Statement *> &ast)
{
  NativeFunction *nv = new NativeFunction (_native_isdecimal, { "self" });
  nv->set_self_arg (true);
  I (nv);
  ast.insert (0, static_cast<Statement *> (new VarDeclStatement (
                     static_cast<Expr *> (new VariableExpr ("''.isdecimal")),
                     static_cast<Expr *> (
